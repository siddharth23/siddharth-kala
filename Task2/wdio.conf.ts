export const config = {
    ...
    capabilities: [
        {    specs: [
         ...
         {    specs: [
                './features/1_*.feature','./features/2_*.feature'
            ],
            // The defaults you need to have in your config
            platformName: 'Android',
            "appium:automationName": "UIAutomator2",
    ...
    jsonFolder: './reports/json', // Path to save JSON files
    language: 'en',
    }]],
    ...
    cucumberOpts: {
        ...
        require: ['./features/step-definitions/**.ts','./features/hooks/beforeAndAfterAll.ts'],
        ...
        tags:'@Income or @Expense or @ListView'
    },
